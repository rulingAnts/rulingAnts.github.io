...
| :--- | :--- | :--- | :--- |
<!-- Flextext Editor — temporarily hidden until the Drive relay moves off Google Apps Script (~150 MB/day quota) to Cloud/Firebase. Re-enable once the backend is scalable.
